...
semestral e a um exame final.

A média das três notas mencionadas obedece aos pesos a seguir: Trabaho de
Laboratório: peso 2; Avaliação Semestral: peso 3; Exame Final 5.

Faça um programa que receba as três notas, calcule e mostre a média pondera e o
conceito que segue a tabela: 8.01 a 10.0 A; 7.01 a 8.0 B; 6.01 a 7.0 C, 5.01
a 6.0 D, 0.0 a 5.0 E */
