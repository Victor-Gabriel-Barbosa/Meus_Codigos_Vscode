...
int consulta_elemento(int posi, int vetor[], int cont) {
  if (posi < 0 || posi >= cont) { // Verifica se a posição é válida
    printf("\n\033[38;5;196m[Posição Inválida!]\033[0m\n");
    return -1; // Código de erro
  }
  return vetor[posi]; // Retorna o elemento na posição especificada
}
